...
| ISA Attribute | Value |
|:--|:--|
| **ISA Name** | `slu4-min64x4-redux-asm` |
| **Version** | 1.4.0 |
| **File Extension** | *.min64x4r |
...
| --- | --- | --- | --- |
| N | `N` | Negative | Indicates value is negative |
| C | `C` | Carry | Indicates there was a carry resulting from math operation |
| Z | `Z` | Zero | Indicates value is zero |
...
| Operand | Syntax | Value | Addressing Mode | Description |
| :-- | :-- | :-- | :-- | :-- |
| Relative Address (`relative_address`) | `relative_address` | numeric expression expressed as 16 bit value | Address | Two byte address pointing two two bytes in memory that contain another address to use. |

### `relative_zero_page`

| Operand | Syntax | Value | Addressing Mode | Description | Details |
| :-- | :-- | :-- | :-- | :-- | :-- |
| Zero Page Address (`zp_relative_addr`) | `zp_relative_addr` | numeric expression expressed as 8 bit value | Address | one byte is interpreted as a zero page address to a word that in turn is used as a relative address. | Valid within `ZERO_PAGE` memory zone.<br><br>Uses only the least significant bits of the address value. |

### `zero_page`

| Operand | Syntax | Value | Addressing Mode | Description | Details |
| :-- | :-- | :-- | :-- | :-- | :-- |
| Zero Page Address (`zp_address`) | `zp_address` | numeric expression expressed as 8 bit value | Address | one byte is interpreted as a zero page address | Valid within `ZERO_PAGE` memory zone.<br><br>Uses only the least significant bits of the address value. |
...
| Type | Target | Description |
| --- | --- | --- |
| Register | A | Set to MSB of result |
| Flag | N | Set based on MSB of result |
| Flag | C | Set based on MSB of result |
| Flag | Z | Set based on MSB of result |

---

### `AC.Z` : Add A to zero-page byte with C: *Z = *Z + A + C
...
| Operand | Type | Value |
| :-- | :-- | :-- |
| `zp_address` | address | numeric expression expressed as 8 bit value |
...
### `ACI` : Add imm byte to A with C: A = A + imm + C
...
### `ACZ` : Add byte in zero-page to A with C: A = A + *Z + C
...
### `AD.B` : Add A to byte at addr: *addr = *addr + A
...
| Operand | Type | Value |
| :-- | :-- | :-- |
| `relative_address` | address | numeric expression expressed as 16 bit value |
...
| Operand | Type | Value |
| :-- | :-- | :-- |
| `zp_relative_addr` | address | numeric expression expressed as 8 bit value |
...
### `ADW` : Add A to word at addr: *addr = *addr + A
...
### `AIB` : Add imm to byte at addr: *addr = *addr + imm
...
### `AIQ` : Add imm byte to zero-page long: *Q = *Q + imm
...
### `AIR` : Add imm to byte at rel adr: *(*adr) = *(*adr) + imm

*Calling syntax:*

```asm
AIR int8, relative_address
```
...
### `AIV` : Add imm byte to zero-page word: *V = *V + imm
...
### `AIZ` : Add imm byte to zero-page byte: *Z = *Z + imm
...
### `AN.R` : Bitwise AND: **addr = A & **addr

*Calling syntax:*

```asm
AN.R relative_address
```
...
### `AN.T` : Bitwise AND: **Z = A & **Z

*Calling syntax:*

```asm
AN.T zp_relative_addr
```
...
### `ATT` : Add byte at rel ZP to rel ZP: **Z2 = **Z2 + **Z1

*Calling syntax:*

```asm
ATT zp_relative_addr1, zp_relative_addr2
```
...
| Operand | Type | Value |
| :-- | :-- | :-- |
| `zp_relative_addr1` | address | numeric expression expressed as 8 bit value |
| `zp_relative_addr2` | address | numeric expression expressed as 8 bit value |
...
### `ATZ` : Add byte at rel ZP addr to ZP byte: *Z2 = *Z2 + **Z1

*Calling syntax:*

```asm
ATZ zp_relative_addr1, zp_relative_addr2
```
...
| Operand | Type | Value |
| :-- | :-- | :-- |
| `zp_address1` | address | numeric expression expressed as 8 bit value |
| `zp_address2` | address | numeric expression expressed as 8 bit value |
...
### `AZT` : Add ZP byte to rel ZP address: **Z2 = **Z2 + *Z1

*Calling syntax:*

```asm
AZT zp_relative_addr1, zp_relative_addr2
```
...
### `DEW` : Decrement word at addr: *addr = *addr - 0x0001
...
### `INB` : Increment byte at addr: *addr = *addr + 1
...
### `INW` : Increment word at addr: *addr = *addr + 0x0001
...
| --- | --- | --- |
| Register | A | Updated |
| Flag | N | Set to LSB of result |
| Flag | C | Set to LSB of result |
| Flag | Z | Set to LSB of result |

---

### `LAP` : Load A A-indexed from page: A = *(page<<8 + A)
...
### `LZP` : Load A Z-indexed from page: A = *(page<<8 + *Z)
...
### `NEB` : Negate byte at address: *addr = -*addr
...
### `NEW` : Negate word at address (C = 1 only if word = 0)
...
### `NOW` : Bitwise NOT word at address
...
### `OR.R` : Bitwise OR: **addr = A | **addr

*Calling syntax:*

```asm
OR.R relative_address
```
...
### `OR.T` : Bitwise OR: **Z = A | **Z

*Calling syntax:*

```asm
OR.T zp_relative_addr
```
...
### `RLB` : Rotate left byte at addr 1 step via C
...
### `RLW` : Rotate left word at addr 1 step via C
...
### `RRB` : Rotate right byte at addr 1 step via C
...
### `SC.Z` : Sub A from zero-page byte with C: *Z = *Z - A - 1 + C
...
### `SCI` : Sub imm byte from A with C: A = A - imm - 1 + C
...
### `SCZ` : Sub byte in ZP from A with C: A = A - *Z - 1 + C
...
### `STT` : Sub byte at rel ZP from rel ZP: **Z2 = **Z2 - **Z1

*Calling syntax:*

```asm
STT zp_relative_addr1, zp_relative_addr2
```
...
### `STZ` : Sub byte at rel ZP addr from ZP byte: *Z2 = *Z2 - **Z1

*Calling syntax:*

```asm
STZ zp_address1, zp_address2
```
...
### `SU.B` : Sub A from byte at addr: *addr = *addr - A
...
### `SUW` : Sub A from word at addr: *addr = *addr - A
...
### `SZP` : Store A Z-indexed to page: *(page<<8 + *Z) = A
...
### `SZT` : Sub ZP byte from rel ZP address: **Z2 = **Z2 + *Z1

*Calling syntax:*

```asm
SZT zp_relative_addr1, zp_relative_addr2
```
...
### `XR.R` : Bitwise XOR: **addr = A ^ **addr §

*Calling syntax:*

```asm
XR.R relative_address
```
...
### `XR.T` : Bitwise XOR: **Z = A ^ **Z

*Calling syntax:*

```asm
XR.T zp_relative_addr
```
...
### `RAP` : Read A-indexed FLASH data: A = *(page<<8 + A)
...
### `RZP` : Read Z-indexed FLASH data: A = *(page<<8 + *Z)

*Calling syntax:*

```asm
RZP zp_address, int81, int82
```
...
### `CL5` : Clear data at rel ZP: **Z = 0x0000000000 and *Z += 5

*Calling syntax:*

```asm
CL5 zp_relative_addr
```
...
### `CLL` : Clear long at addr: *addr = 0x00000000
...
### `CLQ` : Clear long at zero-page addr: *Q = 0x00000000
...
### `CLV` : Clear word at zero-page addr: *V = 0x0000
...
### `CLZ` : Clear byte at zero-page addr: *Z = 0x00
...
### `LDB` : Load A from address: A = *addr
...
### `MBB` : Move byte at adr1 to adr2: *adr2 = *adr1
...
### `MBR` : Move byte at adr1 to rel adr2: **adr2 = *adr1
...
### `MBT` : Move byte at addr to rel ZP addr: **Z = *addr

*Calling syntax:*

```asm
MBT relative_address, zp_relative_addr
```
...
### `MBZ` : Move byte at addr to zero-page: *Z = *addr

*Calling syntax:*

```asm
MBZ address, zp_address
```
...
### `MIB` : Move imm byte to addr: *addr = imm
...
### `MIW` : Move imm word to addr: *addr = imm
...
### `MRB` : Move byte at rel adr1 to adr2: *adr2 = **adr1
...
### `MRR` : Move byte at rel adr1 to rel adr2: **adr2 = **adr1
...
### `MRT` : Move byte at rel addr to rel ZP addr: **Z = **addr

*Calling syntax:*

```asm
MRT relative_address, zp_relative_addr
```
...
### `MRZ` : Move byte at rel addr to ZP addr: *Z = **addr

*Calling syntax:*

```asm
MRZ relative_address, zp_address
```
...
### `MTB` : Move byte at rel ZP addr to addr: *addr = **Z

*Calling syntax:*

```asm
MTB zp_relative_addr, relative_address
```
...
### `MTR` : Move byte at rel ZP addr to rel addr: **addr = **Z

*Calling syntax:*

```asm
MTR zp_relative_addr, relative_address
```
...
### `MTT` : Move byte at rel ZP adr to rel ZP adr: **Z2 = **Z1

*Calling syntax:*

```asm
MTT zp_relative_addr1, zp_relative_addr2
```
...
### `MTZ` : Move byte at rel ZP addr to ZP addr: *Z2 = **Z1

*Calling syntax:*

```asm
MTZ zp_relative_addr1, zp_relative_addr2
```
...
### `MVV` : Move word at ZP addr to word at ZP addr: *V2 = *V1

*Calling syntax:*

```asm
MVV zp_address1, zp_address2
```
...
### `MWV` : Move word at addr to word at ZP addr: *V = *addr

*Calling syntax:*

```asm
MWV address, zp_address
```
...
### `MZB` : Move byte at ZP addr to addr: *addr = *Z

*Calling syntax:*

```asm
MZB zp_address, address
```
...
### `MZR` : Move byte at ZP addr to rel addr: **addr = *Z1

*Calling syntax:*

```asm
MZR zp_address, relative_address
```
...
### `MZT` : Move byte at ZP addr to rel ZP addr: **Z2 = *Z1

*Calling syntax:*

```asm
MZT zp_relative_addr1, zp_relative_addr2
```
...
### `MZZ` : Move byte at ZP addr to zero-page addr: *Z2 = *Z1

*Calling syntax:*

```asm
MZZ zp_address1, zp_address2
```
...
### `SDR` : Store A at relative address: **addr = A

*Calling syntax:*

```asm
SDR relative_address
```
...
### `SDT` : Store A at rel address in zero page: **Z = A

*Calling syntax:*

```asm
SDT zp_relative_addr
```
...
### `SDS` : Store on stack: *(0xff00 + SP + off) = A
...
### `CBB` : Compare byte at adr1 to byte at adr2: LDB adr2 CPB adr1
...
### `CIB` : Compare imm byte to byte at addr: LDB addr CPI ..
...
### `CIR` : Compare imm byte to byte at rel addr: LDR addr CPI ..

*Calling syntax:*

```asm
CIR int8, relative_address
```
...
### `CIT` : Compare imm byte to byte at rel Z: LDT Z CPI ..

*Calling syntax:*

```asm
CIT int8, zp_relative_addr
```
...
### `CIV` : Compare imm word to word in ZP: eval *V – imm

*Calling syntax:*

```asm
CIV int16, zp_address
```
...
### `CIW` : Compare imm word to ZP word: eval *addr – imm
...
### `CIZ` : Compare imm byte to zero-page byte: LDZ Z CPI ..
...
### `CPI` : Compare imm byte to A: eval A - imm
...
### `CPR` : Compare byte at rel addr to A: eval A - **addr

*Calling syntax:*

```asm
CPR relative_address
```
...
### `CPZ` : Compare byte in zero-page to A: eval A - *Z
...
### `CTT` : Compare byte at rel ZP to rel ZP byte: LDT Z2 CPT Z1
...
### `CTZ` : Compare byte at rel ZP to ZP byte: LDZ Z2 CPT Z1

*Calling syntax:*

```asm
CTZ zp_relative_addr1, zp_relative_addr2
```
...
### `CVV` : Compare word in ZP to ZP word: eval *V2 - *V1

*Calling syntax:*

```asm
CVV zp_address1, zp_address2
```
...
### `CZT` : Compare byte in ZP to rel ZP addr: LDT Z2 CPZ Z1

*Calling syntax:*

```asm
CZT zp_relative_addr1, zp_relative_addr2
```
...
### `CZZ` : Compare byte in ZP to ZP byte: LDZ Z2 CPZ Z1

*Calling syntax:*

```asm
CZZ zp_address1, zp_address2
```
...
### `AQQ` : Add zero-page long to another zero-page long

*Calling syntax:*

```asm
AQQ zp_address1, zp_address2
```
...
### `M4IQ` : move 4 byte long from immediate to zero-page long

*Calling syntax:*

```asm
M4IQ int32, zp_address
```
